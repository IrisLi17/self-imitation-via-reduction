...
class EnsembleSAC(OffPolicyRLModel):
    """
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=3e-4, buffer_size=50000,
        ...
        super(EnsembleSAC, self).__init__(policy=policy, env=env, replay_buffer=None, verbose=verbose,
        ...
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                with tf.variable_scope("model", reuse=False):
                    ...
                    qf1, qf2, value_fn, value_ensemble = self.policy_tf.make_critics(self.processed_obs_ph, self.actions_ph,
                                                                                     n_values=5,
                                                                                     create_qf=True, create_vf=True)
                    qf1_pi, qf2_pi, _, _ = self.policy_tf.make_critics(self.processed_obs_ph,
                ...
                with tf.variable_scope("target", reuse=False):
                    ...
                    _, _, value_target, _ = self.target_policy.make_critics(self.processed_next_obs_ph,
