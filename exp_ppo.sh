...
CUDA_VISIBLE_DEVICES=2 python run_ppo_augment.py --env FetchPushWallObstacle-v4 --random_ratio 0.7 --num_timesteps 1e8 --n_subgoal 4 --log_path logs/FetchPushWallObstacle-v4_heavy_random0.7_fixz/ppo_augment/1
