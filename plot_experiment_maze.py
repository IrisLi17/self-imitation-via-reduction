...
if __name__ == '__main__':
    ...
    for subfolder in subfolders:
        for i in range(3):
            ...
            success_rate_iteration = smooth(raw_success_rate[:L], 20)
    ...
    df_success_rate_iteration = np.concatenate(df_success_rate_iteration, axis=0).tolist()
    ...
    data = {'iterations': df_iteration, 'eval': df_success_rate_iteration, 'algo': df_legend_iteration}
    sr_iteration = pandas.DataFrame(data)
    ...
    sns.lineplot(x='iterations', y='eval', hue='algo', ax=axes[1], data=sr_iteration)
