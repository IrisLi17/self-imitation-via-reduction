...
CUDA_VISIBLE_DEVICES=0 python run_ppo_augment.py --env MasspointPushDoubleObstacle-v1 --policy AttentionPolicy --num_timesteps 3e8 --random_ratio 0.7 --n_subgoal 2 --parallel --aug_clip 0.0 --reuse_times 4 --start_augment 3e7 --sil_clip 0.15 --log_path logs/MasspointPushDoubleObstacle-v1_random0.7_new2/ppo_attention_aug/bothdata0.15_start3e7_re4_all_demoadvclip1_neglogpclip20
