...
if __name__ == '__main__':
    ...
    f.legend(handles[1:], labels[1:], loc="lower right", bbox_to_anchor=(0.9, 0.1), ncol=1, title='')
    plt.savefig(os.path.join(folder_name, '../', os.path.basename(folder_name) + mode + '.png'))
    # plt.show()
