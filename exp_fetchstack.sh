...
CUDA_VISIBLE_DEVICES=0 python run_ppo.py --env FetchStack-v1 --curriculum --reward_type sparse --n_object 2 --gamma 0.99 --num_timesteps 1e9 --log_path logs/FetchStack-v1_adapt/ppo_attention/2obj_0
...
CUDA_VISIBLE_DEVICES=0 python run_ppo_augment.py --env FetchStack-v1 --curriculum --reward_type sparse --n_object 2 --num_timesteps 1e9 --n_subgoal 2 --parallel --aug_clip 0.0 --start_augment 2e8 --reuse_times 4 --log_path logs/FetchStack-v1_adapt/ppo_augment/2obj_reuse4_0
