...
CUDA_VISIBLE_DEVICES=0 python run_ppo.py --env FetchStack-v1 --curriculum --reward_type sparse --n_object 2 --num_timesteps 2e8 --log_path logs/FetchStack-v1/ppo_attention/stack2_new/sp0
...
CUDA_VISIBLE_DEVICES=0 python run_ppo_augment.py --env FetchStack-v1 --curriculum --reward_type sparse --n_object 2 --num_timesteps 2e8 --n_subgoal 2 --parallel --aug_clip 0.0 --reuse_times 8 --log_path logs/FetchStack-v1/ppo_augment/stack2_new/sp0_reuse8
