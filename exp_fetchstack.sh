...
CUDA_VISIBLE_DEVICES=0 python run_ppo_augment.py --env FetchStack-v1 --random_ratio 0.7 --reward_type sparse --n_object 2 --num_timesteps 2e8 --n_subgoal 2 --parallel --aug_clip 0.0 --reuse_times 4 --log_path logs/FetchStack-v1/ppo_augment/stack2/sp0_reuse4
