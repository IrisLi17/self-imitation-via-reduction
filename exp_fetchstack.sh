...
CUDA_VISIBLE_DEVICES=0 python run_ppo.py --env FetchStack-v1 --curriculum --reward_type sparse --n_object 2 --gamma 0.99 --num_timesteps 1e9 --log_path logs/FetchStack-v1_adapt/ppo_attention/stack2_v2/sp0_gamma0.99_newpolicy3
CUDA_VISIBLE_DEVICES=0 python run_ppo.py --env FetchStack-v1 --curriculum --reward_type incremental --n_object 2 --gamma 0.99 --num_timesteps 1e9 --log_path logs/FetchStack-v1_adapt/ppo_attention/stack2_v2/ic0_gamma0.99
CUDA_VISIBLE_DEVICES=0 python run_ppo_augment.py --env FetchStack-v1 --curriculum --reward_type sparse --n_object 2 --num_timesteps 1e9 --n_subgoal 2 --parallel --aug_clip 0.0 --start_augment 3e8 --reuse_times 4 --log_path logs/FetchStack-v1_adapt/ppo_augment/stack2_v2/sp0_gamma0.99_newpolicy3_reuse4
...
# Pure stacking
CUDA_VISIBLE_DEVICES=0 python run_ppo.py --env FetchStack-v1 --random_ratio 0.0 --reward_type sparse --n_object 2 --num_timesteps 1e9 --log_path logs/FetchStack-v1_0fix/ppo_attention/sp0
CUDA_VISIBLE_DEVICES=0 python run_ppo.py --env FetchStack-v0 --reward_type sparse --n_object 2 --num_timesteps 1e9 --log_path logs/FetchStack-v0/ppo_attention/sp0
