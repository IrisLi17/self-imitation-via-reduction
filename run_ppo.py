...
from run_ppo_augment import eval_model, log_eval, stack_eval_model,eval_img_model
...
import gym
from utils.wrapper import DoneOnSuccessWrapper, ScaleRewardWrapper,VAEWrappedEnv
import pickle,csv
import numpy as np
...
def main(env_name, seed, num_timesteps, log_path, load_path, play, export_gif, random_ratio, reward_type, n_object,
         curriculum, gamma, policy,epsilon):
...
if __name__ == '__main__':
    ...
    main(env_name=args.env, seed=args.seed, num_timesteps=int(args.num_timesteps), 
         ...
         curriculum=args.curriculum, gamma=args.gamma, policy=args.policy,epsilon=args.epsilon)
