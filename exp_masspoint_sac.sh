...
# Priority
CUDA_VISIBLE_DEVICES=0 python run_her.py --env MasspointPushDoubleObstacle-v1 --random_ratio 0.7 --policy AttentionPolicy --num_timesteps 3e6 --num_workers 32 --priority --log_path logs/MasspointPushDoubleObstacle-v1_random0.7_new2/her_sac_32workers/attention_priority
CUDA_VISIBLE_DEVICES=0 python run_her.py --env MasspointPushDoubleObstacle-v1 --random_ratio 0.7 --reward_type dense --policy AttentionPolicy --num_timesteps 3e6 --num_workers 32 --priority --log_path logs/MasspointPushDoubleObstacle-v1_random0.7_new2/her_sac_32workers/ds_priority
CUDA_VISIBLE_DEVICES=0 python run_her.py --env MasspointPushDoubleObstacle-v1 --random_ratio 0.7 --policy AttentionPolicy --num_timesteps 3e6 --num_workers 32 --sil --sil_coef 0.1 --priority --log_path logs/MasspointPushDoubleObstacle-v1_random0.7_new2/her_sac_sil_32workers/attention_0.1_priority
