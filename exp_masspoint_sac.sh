...
CUDA_VISIBLE_DEVICES=0 python run_her_augment.py --env MasspointPushDoubleObstacle-v1 --random_ratio 0.7 --policy AttentionPolicy --num_timesteps 1e7 --num_workers 32 --start_augment 2e7 --imitation_coef 0.1 --log_path logs/MasspointPushDoubleObstacle-v1_random0.7/her_sac_aug_32workers/attention_start2e7_silloss0.1_priority
