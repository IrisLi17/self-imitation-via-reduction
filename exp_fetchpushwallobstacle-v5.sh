...
# fix z, augment
CUDA_VISIBLE_DEVICES=0 python test_universal_augment.py --env FetchPushWallObstacle-v5 --policy CustomSACPolicy --trained_model logs/FetchPushWallObstacle-v5/her_sac/final.zip --random_gripper --num_timesteps 1e7 --augment_when_success --n_subgoal 10 --log_path logs/FetchPushWallObstacle-v5/her_sac_augment_filter
CUDA_VISIBLE_DEVICES=0 python test_universal_augment.py --env FetchPushWallObstacle-v5 --policy CustomSACPolicy --trained_model logs/FetchPushWallObstacle-v5/her_sac/final.zip --random_gripper --num_timesteps 1e7 --augment_when_success --n_subgoal 10 --random_ratio 0.7 --log_path logs/FetchPushWallObstacle-v5_random0.7/her_sac_augment_filter
