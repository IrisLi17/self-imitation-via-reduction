...
def main(env_name, seed, num_timesteps, log_path, load_path, play):
    ...
    if not play:
        ...
        # Wrap the model
        model = SPHER('MlpPolicy', env, model_class, n_sampled_goal=4, goal_selection_strategy=goal_selection_strategy,
    ...
    if play and rank == 0:
        ...
        model = SPHER.load(load_path, env=env)
