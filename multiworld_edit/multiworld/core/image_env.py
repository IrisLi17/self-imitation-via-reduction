...
class ImageEnv(ProxyEnv, MultitaskEnv):
    ...
    def reset(self):
        ...
        #wrapped_env_reset_time0 = time.time()
        #print('image_env_reset')
        obs = self.wrapped_env.reset()
        #wrapped_env_reset_time = time.time()-wrapped_env_reset_time0
        #print('wrapped_env_reset_time',wrapped_env_reset_time)
        ...
        #update_obs_time0 = time.time()
        #obs = self._update_obs(obs)
        #update_obs_time = time.time() - update_obs_time0
       # print('image_env_update_obs_time',update_obs_time)
       # reset_time = time.time()-reset_time0
       # print('image_env_reset_time',reset_time)
       # return obs
