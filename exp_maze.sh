...
CUDA_VISIBLE_DEVICES=0 python run_ppo.py --env MasspointMaze-v3 --random_ratio 1.0 --num_timesteps 1e5 --curriculum --log_path logs/MasspointMaze-v3_fixstart/ppo_cu/0
